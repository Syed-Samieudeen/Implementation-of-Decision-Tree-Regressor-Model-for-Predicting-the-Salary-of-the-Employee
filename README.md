...
4. Create a Decision Tree Regressor model with a specified criterion and train model using training data.
## Program:
```
/*
Program to implement the Decision Tree Regressor Model for Predicting the Salary of the Employee.
Developed by: Syed Samieudeen
RegisterNumber:  21225240165
*/
```
```
import pandas as pd
...
## Output:
<img width="631" height="615" alt="image" src="https://github.com/user-attachments/assets/e6d8f92e-ea38-4f6a-8688-0e0d75c053fc" />
